...
return [
    'routes' => [
        ...
        ['name' => 'filter#filterFiles', 'url' => '/api/groupfolders/{groupfolderId}/filter', 'verb' => 'POST'],
        ['name' => 'filter#getFilterFields', 'url' => '/api/groupfolders/{groupfolderId}/filter-fields', 'verb' => 'GET'],
        ...
        ['name' => 'License#getInfo', 'url' => '/api/license/info', 'verb' => 'GET'],
        ['name' => 'License#checkLimit', 'url' => '/api/license/check-limit', 'verb' => 'GET'],
        ['name' => 'License#getConfig', 'url' => '/api/license/config', 'verb' => 'GET'],
        ['name' => 'License#saveConfig', 'url' => '/api/license/config', 'verb' => 'POST'],
    ],

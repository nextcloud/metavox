...
function registerMetadataTab() {
	console.log('🧩 MetaVox Files Plugin (Vue) - Registering sidebar tab')
	...
	window.OCA.Files.Sidebar.registerTab(new window.OCA.Files.Sidebar.Tab({
		...
		async mount(el, fileInfo, context) {
			console.log('🧩 MetaVox - Mounting sidebar tab for file:', fileInfo)
		...
		update(fileInfo) {
			console.log('🧩 MetaVox - Updating sidebar tab for file:', fileInfo)
		...
		destroy() {
			console.log('🧩 MetaVox - Destroying sidebar tab')
	...
	console.log('✅ MetaVox Files Plugin (Vue) - Sidebar tab registered successfully')
}

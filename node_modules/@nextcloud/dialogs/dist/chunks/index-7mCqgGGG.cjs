"use strict";
const p = require("@nextcloud/l10n/gettext"), w = require("vue");
var y = Object.defineProperty, v = (s, e, i) => e in s ? y(s, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : s[e] = i, t = (s, e, i) => (v(s, typeof e != "symbol" ? e + "" : e, i), i), a = /* @__PURE__ */ ((s) => (s[s.Choose = 1] = "Choose", s[s.Move = 2] = "Move", s[s.Copy = 3] = "Copy", s[s.CopyMove = 4] = "CopyMove", s[s.Custom = 5] = "Custom", s))(a || {});
class l {
  constructor(e, i, r, m, o, c, f, u, h) {
    t(this, "title"), t(this, "multiSelect"), t(this, "mimeTypeFiler"), t(this, "modal"), t(this, "type"), t(this, "directoriesAllowed"), t(this, "buttons"), t(this, "path"), t(this, "filter"), this.title = e, this.multiSelect = i, this.mimeTypeFiler = r, this.modal = m, this.type = o, this.directoriesAllowed = c, this.path = f, this.filter = u, this.buttons = h;
  }
  async pick() {
    const e = (await Promise.resolve().then(() => require("../legacy.cjs"))).filepicker;
    return new Promise((i) => {
      var r;
      const m = (r = this.buttons) == null ? void 0 : r.map((o) => ({
        defaultButton: o.type === "primary",
        label: o.text,
        type: o.id
      }));
      e(
...
class g {
  constructor(e) {
    t(this, "title"), t(this, "multiSelect", !1), t(this, "mimeTypeFiler", []), t(this, "modal", !0), t(
      this,
      "type",
      1
      /* Choose */
    ), t(this, "directoriesAllowed", !1), t(this, "path"), t(this, "filter"), t(this, "buttons", []), this.title = e;
  }
  setMultiSelect(e) {
  ...
  build() {
    var e;
    return ((e = this.buttons) == null ? void 0 : e.length) > 0 && this.type !== 5 && console.error("FilePickerBuilder: When adding custom buttons the `type` must be set to `FilePickerType.Custom`."), new l(
      this.title,
      this.multiSelect,
      this.mimeTypeFiler,
      this.modal,
 ...
 *
 */
const C = w.defineAsyncComponent(() => Promise.resolve().then(() => require("./FilePicker-m8UNxUO0.cjs")));
exports.FilePicker = l;
exports.FilePickerBuilder = g;
exports.FilePickerType = a;
exports.FilePickerVue = C;
exports.getFilePickerBuilder = F;
exports.t = N;

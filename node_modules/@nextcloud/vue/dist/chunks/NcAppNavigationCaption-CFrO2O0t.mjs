import '../assets/NcAppNavigationCaption-Cgexlz2n.css';
...
const _sfc_main = {
  ...
  computed: {
    ...
    captionTag() {
      ...
      return this.isHeading ? "h".concat(headingLevel) : "span";
    },
...
//# sourceMappingURL=NcAppNavigationCaption-CFrO2O0t.mjs.map

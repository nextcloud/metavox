...
export interface WebDAVClient {
    ...
    createWriteStream: (filename: string, options?: CreateWriteStreamOptions, callback?: CreateWriteStreamCallback) => WritableLike;
    ...
    getDirectoryContents(path: string, options: GetDirectoryContentsOptionsWithDetails): Promise<ResponseDataDetailed<Array<FileStat>>>;
    getDirectoryContents(path: string, options: GetDirectoryContentsOptionsWithoutDetails): Promise<Array<FileStat>>;
    ...
    moveFile: (filename: string, destinationFilename: string, options?: MoveFileOptions) => Promise<void>;
    putFileContents: (filename: string, data: string | BufferLike | ReadableLike, options?: PutFileContentsOptions) => Promise<boolean>;
    partialUpdateFileContents: (filePath: string, start: number, end: number, data: string | BufferLike | ReadableLike, options?: WebDAVMethodOptions) => Promise<void>;
 ...
 */
export type WebDAVAttributeParser = (jPath: string, attributeValue: string) => string | unknown | undefined;
/**

...
/**
 * Convert comma-separated multiselect values to semicolon with space separated
 */
class Version20250101000008 extends SimpleMigrationStep {
    ...
    public function postSchemaChange(IOutput $output, \Closure $schemaClosure, array $options): void {
        try {
            $output->info('Converting comma-separated multiselect values to semicolon-separated...');
            ...
            if (count($multiselectFieldIds) > 0) {
                // Convert metavox_metadata (uses field_id)
            ...
            if (count($multiselectFieldNames) > 0) {
                // Convert metavox_gf_metadata (uses field_name)
                ...
                // Convert metavox_file_gf_meta (uses field_name)
            ...
            $output->info('Successfully converted all multiselect values from comma to semicolon');
